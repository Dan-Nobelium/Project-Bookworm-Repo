...
const demographics_block = {
  ...
  html:
    ...
    '<input type="radio" name="gender" value="other" id="gender-other" required/> <label for="gender-other">Other</label><br>' +
    "<br>" +
    '<p> <label for="age">Age:</label> <input name="age" type="number" min="1" max="99" id="age" required/> </p>' +
    "<br>" +
    '<p> <label for="languageDropdown">Native language:</label> <select name="language" type="text" id="languageDropdown" required/> </select> </p>' +
    "<br>",
  data: {
    phase: "demographics",
  },
...
const questions = [
  {
    ...
    options: [
      ...
      "Battle the aliens on the planets",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Sometimes result in a successful trade, earning me points",
    ],
    correct: "Sometimes result in a successful trade, earning me points",
  },
  {
    prompt:
      "<b>Question 3:</b> There will be multiple blocks in this experiment, with questions in between each block.",
    options: ["FALSE", "TRUE"],
    correct: "TRUE",
  },
  {
    prompt:
      "<b>Question 4:</b> The top 10% performers at the end of the task will receive:",
...
contact = [
  "If you would like to receive a copy of the study results via email, please provide your email address below. Your email address will be used for this purpose only, and will not be stored alongside your data.",
];
...
const cfi = {};
cfi.prompt =
  "<b>Please rate how much you agree with the following statements. There are no right or wrong answers.</b>";
cfi.labels = [
...
const audit = {};
audit.prompt =
  "<b>Please answer the following questions about your alcohol use during the <b>past 12 months</b>.</b>";
audit.items = [
...
audit.labels1 = [
  "never",
  "monthly<br>or<br>less",
  "2-4 times<br>a<br>month",
  "2-3<br>times<br>a<br>week",
  "4+<br>times<br>a<br>week",
];
