jsPsych.plugins["inference-check-6"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var html =
      '<div id="jspsych-inference-check-6-wrapper" style="margin: 100px 0px;">';
    ...
    for (var i = 1; i <= 6; i++) {
      ...
      html +=
        '<div class="jspsych-inference-check-6-container" style="position:relative; margin: 0 auto 3em auto; ';
      ...
      html +=
        ...
        '" step="' +
        trial.step +
        '" style="width: 100%;" id="jspsych-inference-check-6-response-' +
        i +
        '"></input>';
      html += "<div>";
    ...
    html +=
      '<button id="jspsych-inference-check-6-next" class="jspsych-btn" ' +
    ...
    if (trial.require_movement) {
      display_element
        .querySelector("#jspsych-inference-check-6-response-6")
        .addEventListener("change", function () {
          display_element.querySelector(
            "#jspsych-inference-check-6-next",
          ).disabled = false;
        });
    }
    ...
    display_element
      .querySelector("#jspsych-inference-check-6-next")
      .addEventListener("click", function () {
        ...
        for (var i = 1; i <= 6; i++) {
          response.responses[i - 1] = display_element.querySelector(
            "#jspsych-inference-check-6-response-" + i,
          ).value;
        }
    ...
    if (trial.stimulus_duration !== null) {
      jsPsych.pluginAPI.setTimeout(function () {
        display_element.querySelector(
          "#jspsych-inference-check-6-stimulus",
