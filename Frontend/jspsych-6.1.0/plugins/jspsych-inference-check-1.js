...
jsPsych.plugins["inference-check-1"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    var html =
      '<div id="jspsych-inference-check-1-wrapper" style="margin: 100px 0px;">';
    ...
    // slider
    html +=
      '<div class="jspsych-inference-check-1-container" style="position:relative; margin: 0 auto 3em auto; ';
    ...
    html +=
      ...
      '" step="' +
      trial.step +
      '" style="width: 100%;" id="jspsych-inference-check-1-response"></input>';
    html += "<div>";
    ...
    // add submit button
    html +=
      '<button id="jspsych-inference-check-1-next" class="jspsych-btn" ' +
    ...
    if (trial.require_movement) {
      display_element
        .querySelector("#jspsych-inference-check-1-response")
        .addEventListener("change", function () {
          display_element.querySelector(
            "#jspsych-inference-check-1-next",
          ).disabled = false;
        });
    }

    display_element
      .querySelector("#jspsych-inference-check-1-next")
      .addEventListener("click", function () {
        // measure response time
        var endTime = performance.now();
        response.rt = endTime - startTime;
        response.response = display_element.querySelector(
          "#jspsych-inference-check-1-response",
        ).value;
    ...
    if (trial.stimulus_duration !== null) {
      jsPsych.pluginAPI.setTimeout(function () {
        display_element.querySelector(
          "#jspsych-inference-check-1-stimulus",
