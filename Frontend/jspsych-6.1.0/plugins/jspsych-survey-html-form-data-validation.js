jsPsych.plugins["survey-html-form-data-validation"] = (function () {
  ...
  plugin.info = {
    ...
    description:
      "Displays a survey form with HTML content, language selection, and data validation.",
    parameters: {
      preamble: {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    html +=
      '<div id="jspsych-survey-html-form-error-message" style="color: red; display: none"></div>';
    ...
    // Add submit button
    html +=
      '<button id="jspsych-survey-html-form-next" class="jspsych-btn">' +
      trial.button_label +
      "</button>";
    display_element.innerHTML = html;
    display_element
      .querySelector("#jspsych-survey-html-form-next")
      .addEventListener("click", function () {
        ...
        const errorMessageElement = display_element.querySelector(
          "#jspsych-survey-html-form-error-message",
        );
