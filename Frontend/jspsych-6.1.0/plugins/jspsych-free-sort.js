  ...
  plugin.info = {
    ...
    parameters: {
      ...
      sort_area_height: {
        ...
        default: 800,
        description:
          "The height of the container that subjects can move the stimuli in.",
      },
      sort_area_width: {
        type: jsPsych.plugins.parameterType.INT,
        ...
        default: 800,
        description:
          "The width of the container that subjects can move the stimuli in.",
      },
      prompt: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: "Prompt",
