...
jsPsych.plugins["iat-image"] = (function () {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      stim_key_association: {
        ...
        default: "undefined",
        description:
          'Stimulus will be associated with eight "left" or "right".',
      },
      response_ends_trial: {
        type: jsPsych.plugins.parameterType.BOOL,
  ...
  plugin.trial = function (display_element, trial) {
    ...
    html_str +=
      "<div id='trial_left_align' style='position: absolute; top: 18%; left: 20%'>";
    ...
    var leftKeyCode = jsPsych.pluginAPI.convertKeyCharacterToKeyCode(
      trial.left_category_key,
    );
    var rightKeyCode = jsPsych.pluginAPI.convertKeyCharacterToKeyCode(
      trial.right_category_key,
    );
    ...
    var after_response = function (info) {
      ...
      display_element.querySelector("#jspsych-iat-stim").className +=
        " responded";
    ...
    if (
      trial.left_category_key != jsPsych.NO_KEYS &&
      trial.right_category_key != jsPsych.NO_KEYS
    ) {
