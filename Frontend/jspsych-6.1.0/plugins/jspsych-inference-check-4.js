...
jsPsych.plugins["inference-check-4"] = (function () {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      slider_text_bottom: {
        ...
        default: null,
        description:
          "Any content here will be displayed with the bottom slider.",
      },
      labels_top: {
  ...
  plugin.trial = function (display_element, trial) {
    var html =
      '<div id="jspsych-inference-check-4-wrapper" style="margin: 100px 0px;">';
    ...
    // slider
    html +=
      '<div class="jspsych-inference-check-4-container" style="position:relative; margin: 0 auto 3em auto; ';
    ...
    html +=
      ...
      '" step="' +
      trial.step +
      '" style="width: 100%;" id="jspsych-inference-check-4-response"></input>';
    html += "<div>";
    ...
    html +=
      ...
      '" step="' +
      trial.step +
      '" style="width: 100%;" id="jspsych-inference-check-4-response2"></input>';
    html += "<div>";
    for (var j = 0; j < trial.labels_top.length; j++) {
      var width = 100 / (trial.labels_top.length - 1);
      var left_offset = j * (100 / (trial.labels_top.length - 1)) - width / 2;
    ...
    html +=
      ...
      '" step="' +
      trial.step +
      '" style="width: 100%;" id="jspsych-inference-check-4-response3"></input>';
    html += "<div>";
    for (var j = 0; j < trial.labels_top.length; j++) {
      var width = 100 / (trial.labels_top.length - 1);
      var left_offset = j * (100 / (trial.labels_top.length - 1)) - width / 2;
    ...
    html +=
      ...
      '" step="' +
      trial.step +
      '" style="width: 100%;" id="jspsych-inference-check-4-response4"></input>';
    html += "<div>";
    for (var j = 0; j < trial.labels_top.length; j++) {
      var width = 100 / (trial.labels_top.length - 1);
      var left_offset = j * (100 / (trial.labels_top.length - 1)) - width / 2;
    ...
    // add submit button
    html +=
      '<button id="jspsych-inference-check-4-next" class="jspsych-btn" ' +
    ...
    if (trial.require_movement) {
      display_element
        .querySelector("#jspsych-inference-check-4-response4")
        .addEventListener("change", function () {
          display_element.querySelector(
            "#jspsych-inference-check-4-next",
          ).disabled = false;
        });
    }

    display_element
      .querySelector("#jspsych-inference-check-4-next")
      .addEventListener("click", function () {
        ...
        response.response1 = display_element.querySelector(
          "#jspsych-inference-check-4-response",
        ).value;
        ...
        response.response2 = display_element.querySelector(
          "#jspsych-inference-check-4-response2",
        ).value;
        ...
        response.response3 = display_element.querySelector(
          "#jspsych-inference-check-4-response3",
        ).value;
        ...
        response.response4 = display_element.querySelector(
          "#jspsych-inference-check-4-response4",
        ).value;
    ...
    if (trial.stimulus_duration !== null) {
      jsPsych.pluginAPI.setTimeout(function () {
        display_element.querySelector(
          "#jspsych-inference-check-4-stimulus",
