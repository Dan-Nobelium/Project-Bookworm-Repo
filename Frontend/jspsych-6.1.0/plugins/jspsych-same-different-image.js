...
jsPsych.plugins["same-different-image"] = (function () {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      second_stim_duration: {
        ...
        default: 1000,
        description:
          "How long to show the second stimulus for in milliseconds.",
      },
      prompt: {
  ...
  plugin.trial = function (display_element, trial) {
    display_element.innerHTML =
      '<img class="jspsych-same-different-stimulus" src="' +
      trial.stimuli[0] +
      '"></img>';
    ...
    function showSecondStim() {
      ...
      var after_response = function (info) {
        ...
        var skey =
          typeof trial.same_key == "string"
            ? jsPsych.pluginAPI.convertKeyCharacterToKeyCode(trial.same_key)
            : trial.same_key;
        var dkey =
          typeof trial.different_key == "string"
