jsPsych.plugins["valence-check-9"] = (function () {
  ...
  plugin.trial = function (displayElement, trial) {
    ...
    let html =
      '<div id="jspsych-valence-check-10-wrapper" style="margin: 100px 0px;">';
    let startTime;
...
`;
    ...
    if (trial.require_movement) {
      document
        ...
        .addEventListener("change", function () {
          document.querySelector("#jspsych-valence-check-10-next").disabled =
            false;
        });
    }
    ...
    document
      .querySelector("#jspsych-valence-check-10-next")
      .addEventListener("click", function () {
        ...
        response.val_1 = document.querySelector(
          "#jspsych-valence-check-10-response1",
        ).value;
        response.val_2 = document.querySelector(
          "#jspsych-valence-check-10-response2",
        ).value;
        response.val_3 = document.querySelector(
          "#jspsych-valence-check-10-response3",
        ).value;
        response.val_4 = document.querySelector(
          "#jspsych-valence-check-10-response4",
        ).value;
        response.val_5 = document.querySelector(
          "#jspsych-valence-check-10-response5",
        ).value;
        response.val_6 = document.querySelector(
          "#jspsych-valence-check-10-response6",
        ).value;
        response.val_7 = document.querySelector(
          "#jspsych-valence-check-10-response7",
        ).value;
        response.val_8 = document.querySelector(
          "#jspsych-valence-check-10-response8",
        ).value;
        response.val_9 = document.querySelector(
          "#jspsych-valence-check-10-response9",
        ).value;
