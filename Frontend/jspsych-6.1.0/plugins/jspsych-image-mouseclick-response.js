...
jsPsych.plugins["image-mouseclick-response"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    if (Array.isArray(trial.stimulus)) {
      for (var i = 0; i < trial.stimulus.length; i++) {
        html +=
          ...
          trial.stimulus[i] +
          '" ' +
          'id="jspsych-image-mouseclick-response-stimulus-' +
          i +
          '" ' +
          'style="';
    ...
    for (var i = 0; i < trial.stimulus.length; i++) {
      display_element
        .querySelector("#jspsych-image-mouseclick-response-stimulus-" + i)
    ...
    function mousedown(choice) {
      ...
      display_element.querySelector(
        "#jspsych-image-mouseclick-response-stimulus-" + choice,
      ).src = trial.mousedown[choice];
    }
    function mouseleave(choice) {
      //Handle mousedown?
      display_element.querySelector(
        "#jspsych-image-mouseclick-response-stimulus-" + choice,
      ).src = trial.stimulus[choice];
    }
    ...
    function after_response(choice) {
      ...
      display_element.querySelector(
        "#jspsych-image-mouseclick-response-stimulus",
      ).className += " responded";

      // disable all the buttons after a response
      var btns = document.querySelectorAll(
        ".jspsych-image-mouseclick-response-button button",
      );
