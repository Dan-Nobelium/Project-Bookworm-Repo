jsPsych.plugins["audio-slider-response"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var html =
      '<div id="jspsych-audio-slider-response-wrapper" style="margin: 100px 0px;">';
    html +=
      '<div class="jspsych-audio-slider-response-container" style="position:relative; margin: 0 auto 3em auto; ';
    ...
    html +=
      ...
      '" step="' +
      trial.step +
      '" style="width: 100%;" id="jspsych-audio-slider-response-response"></input>';
    html += "<div>";
